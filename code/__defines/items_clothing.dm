...
#define SLOT_HOLSTER	0x8000 //16th bit - higher than this will overflow <<wat that mean?
//
#define SLOT_UNDERWEAR	0x10000
#define SLOT_BRA		0x20000
...
//
#define slot_wear_underwear_str	"slot_wear_underwear"
#define slot_wear_bra_str	"slot_wear_bra"
//
...
var/list/default_onmob_icons = list(
		...
		slot_wear_underwear_str= 'icons/mob/human.dmi',
		slot_wear_bra_str= 'icons/mob/human.dmi'
		)
