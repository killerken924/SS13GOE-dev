...
//	mymob.zone_sel.icon = ui_style
	...
	mymob.zone_sel.overlays += image('icons/mob/zonesel.dmi', "[mymob.zone_sel.selecting]")
//	mymob.zone_sel.overlays += image('icons/mob/zone_sel.dmi', "[mymob.zone_sel.selecting]")
	hud_elements |= mymob.zone_sel
	//
	mymob.hunger_icon = new /obj/screen/hunger()
	mymob.hunger_icon.color = ui_color
	mymob.hunger_icon.alpha = ui_alpha
	src.hotkeybuttons += mymob.hunger_icon
	hud_elements |= mymob.hunger_icon
	//
	mymob.thirst_icon = new /obj/screen/thirst()
	mymob.thirst_icon.color = ui_color
	mymob.thirst_icon.alpha = ui_alpha
	src.hotkeybuttons += mymob.thirst_icon
	hud_elements |= mymob.thirst_icon
	//
	//Stamina
	mymob.action_points_icon = new /obj/screen/action_points()
	mymob.action_points_icon.color = ui_color
	mymob.action_points_icon.alpha = ui_alpha
	src.hotkeybuttons += mymob.action_points_icon
	hud_elements |= mymob.action_points_icon

	mymob.energy_points_icon = new /obj/screen/energy_points()
	mymob.energy_points_icon.color = ui_color
	mymob.energy_points_icon.alpha = ui_alpha
	src.hotkeybuttons += mymob.energy_points_icon
	hud_elements |= mymob.energy_points_icon
	//sleep and rest
	mymob.sleep_icon = new /obj/screen/Sleep()
	mymob.sleep_icon.color = ui_color
	mymob.sleep_icon.alpha = ui_alpha
	src.hotkeybuttons += mymob.sleep_icon
	hud_elements |= mymob.sleep_icon

	mymob.rest_icon = new /obj/screen/Rest()
	...
	mymob.fov_icon = new /obj/screen/Vision_Cone()
	mymob.fov_icon.color = ui_color
	mymob.fov_icon.alpha = ui_alpha
	//src.hotkeybuttons += mymob.fov_icon
	mymob.fov_icon.name = " "
	mymob.fov_icon.screen_loc = "1,1"
