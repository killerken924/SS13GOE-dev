...
//new
#define big_ui_zonesel "EAST-1:28,NORTH-2:23"//
#define ui_thirst	   "EAST-1:28,NORTH-3:23"
#define ui_realhunger  "EAST-1:28,NORTH-4:23"
//stamina
#define ui_action_points	   "EAST-3:28,NORTH-3:23"
#define ui_energy_points	   "EAST-5:28,NORTH-3:23"
//rest and sleep
#define ui_rest 				"EAST-1:28,SOUTH:5"//EAST-1:28,SOUTH:5
...
//Upper-middle right (damage indicators)<<No fuck you.
#define ui_toxin "EAST-1:28,CENTER-4:11"//"EAST-1:28,NORTH-2:27"
#define ui_fire "EAST-1:28,CENTER-3:11"//"EAST-1:28,NORTH-3:25" "EAST-1:28,CENTER-2:11"
...
#define ui_iclothing "WEST:6,SOUTH+2:7"//"WEST:6,SOUTH+1:7"
#define ui_oclothing "WEST+1:8,SOUTH+2:7"//"WEST+1:8,SOUTH+1:7"
#define ui_gloves 	 "WEST+2:10,SOUTH+2:7"//"WEST+2:10,SOUTH+1:7"
//
#define ui_underwear  "WEST+1:8,SOUTH+1:7"
#define ui_bra "WEST:6,SOUTH+3:9"
//
#define ui_glasses "WEST:6,SOUTH+4:11"//"WEST:6,SOUTH+2:9"
#define ui_mask "WEST+1:8,SOUTH+3:9"//"WEST+1:8,SOUTH+2:9"
#define ui_l_ear "WEST+2:10,SOUTH+3:9"//"WEST+2:10,SOUTH+2:9"
#define ui_r_ear "WEST+2:10,SOUTH+4:11"//"WEST+2:10,SOUTH+3:11"

#define ui_head "WEST+1:8,SOUTH+4:11"//"WEST+1:8,SOUTH+3:11"
