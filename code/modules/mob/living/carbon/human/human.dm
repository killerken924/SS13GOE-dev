...
/mob/living/carbon/human/Stat()
	...
	if(statpanel("Status"))
		...
		if(Skills&&Skills.skills.len)
			...
			stat("EN:","[Skills.get_skill(/datum/realskills/endurance).points]")
			stat("AG:","[Skills.get_skill(/datum/realskills/agility).points]")
		...
		if(level > 1)
			...
			if(level > 2)
				...
				if(nutrition < 40&& hydration <40)
					...
					var/rand_vomit_amount=rand(1,3)
					switch(rand_vomit_amount)
						if(1)
							src.visible_message("<span class='warning'>[src] throws up a little!</span>","<span class='warning'>You throw up a little!</span>")
							nutrition -= 15
							hydration -= 30
						if(2)
							...
							hydration -= 45
						if(2)
							src.visible_message("<span class='danger'>[src] throws up a lot!</span>","<span class='danger'>You throw up a lot!</span>")
							nutrition -= 45
							hydration -= 60
