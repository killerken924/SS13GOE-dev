...
/obj/item/grab/nab/special/init()
	...
	var/armor = victim.run_armor_check(BP_CHEST, "melee")
	victim.apply_damage(15, BRUTE, BP_CHEST, armor, DAM_SHARP, "organic punctures")
	victim.visible_message("<span class='danger'>[attacker]'s spikes dig in painfully!</span>")
	victim.Stun(10)
