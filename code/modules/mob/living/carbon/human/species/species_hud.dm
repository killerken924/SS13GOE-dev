/datum/hud_data
	...
	var/list/gear = list(
		...
		"underwear" =    list("loc" = ui_underwear, "name" = "Underwear",    "slot" = slot_underwear, "state" = "underwear","toggle" = 1),
		"bra" =    		 list("loc" = ui_bra, 		"name" = "Bra",    		 "slot" = slot_bra, 	  "state" = "bra",    "toggle" = 1),
