	...
	switch(disintegrate)
		if(DROPLIMB_EDGE)
			if(!clean)
				...
				playsound(owner.loc,pick('sound/effects/gore/chop1.ogg','sound/effects/gore/chop2.ogg'),50,0)
		...
		if(DROPLIMB_BLUNT)
			...
			playsound(owner.loc,'sound/effects/gore/chop3.ogg',50,0)
			owner.visible_message(
...
/obj/item/organ/external/proc/jostle_bone(force)
	...
	owner.DoScreenJitter(rand(1,5),rand(1,50),rand(1,50))
