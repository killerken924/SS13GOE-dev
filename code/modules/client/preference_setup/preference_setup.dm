...
/datum/category_group/player_setup_category/job_preferences
	name = "Job"
	sort_order = 2
	category_item_type = /datum/category_item/player_setup_item/jobs
...
/datum/category_group/player_setup_category/traits
	name = "Traits"
	sort_order = 8
	category_item_type = /datum/category_item/player_setup_item/realtraits

/datum/category_group/player_setup_category/realskills
	name = "Skills"
	sort_order = 9
	category_item_type = /datum/category_item/player_setup_item/realskills
