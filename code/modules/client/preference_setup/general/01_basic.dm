...
/datum/category_item/player_setup_item/general/basic/content()
	...
	if(pref.gender==FEMALE)
		. += "<b>Breast Size:</b> <a href='?src=\ref[src];boobsize=1'><b>[pref.boobsize]</b></a><br>"
...
/datum/category_item/player_setup_item/general/basic/OnTopic(var/href,var/list/href_list, var/mob/user)
	...
	else if(href_list["boobsize"])
		var/new_boobsize
		if(pref.chosen_traits.Find(/datum/newtraits/unique_body))
			new_boobsize = input(user, "Choose your breast size:", CHARACTER_PREFERENCE_INPUT_TITLE, pref.boobsize) in list("A","B","C","D","DDD")
		else
			new_boobsize = input(user, "Choose your breast size:", CHARACTER_PREFERENCE_INPUT_TITLE, pref.boobsize) in list("A","B","C","D","DD")
		if(new_boobsize && CanUseTopic(user))
			pref.boobsize = new_boobsize
		return TOPIC_REFRESH_UPDATE_PREVIEW
